...
we are using a modified version of the CrowdSim simulator. We made the modification so that Scenic can be interfaced.
...
any rendering.
- Run `python test_scenic_train.py` to see what the simulation looks like during training with Scenic 
